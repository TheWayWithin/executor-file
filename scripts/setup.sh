...
echo "     (scripts/share-sheets.sh prints proper per-holder cover"
echo "      sheets, if you prefer printing to hand-copying.)"
echo "  2. Print the Executor Instructions and store them with the will:"
echo "     scripts/make-guide.sh fills the template from your register"
echo "     (add contacts with role \"share-holder\" and a documents entry"
echo "     for the will first, and it fills nearly everything)."
